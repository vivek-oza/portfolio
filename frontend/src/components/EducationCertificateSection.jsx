...
export default function EducationCertificateSection() {
    return (
        <>
            <div className='flex flex-col space-y-8 border-y border-y-neutral-200 dark:border-y-neutral-800 text-start py-12'>
                ...
                <div className='bg-neutral-200 dark:bg-neutral-800 w-full h-[1px]'></div>
                ...
                <div className='px-12 flex flex-col justify-start space-y-2'>
                    ...
                    <div className="flex flex-col space-y-0 ">
                        ...
                        <a href="#" className='group text-neutral-600 dark:text-neutral-400 flex flex-row justify-between items-center'>
                            <div className='relative'>Python (Basic) Certification exam
