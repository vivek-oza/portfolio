...
export default function ImageChip({ image_src, image_alt, image_title, className }) {
    return (
        <div className='inline-block m-2 cursor-pointer group'>
            <div className={`${className} relative flex justify-between items-center flex-row hover:bg-neutral-200 dark:hover:bg-neutral-800 rounded p-1 border border-neutral-500 dark:border-neutral-700 w-fit h-fit transition-all duration-300`}>
                <div>
